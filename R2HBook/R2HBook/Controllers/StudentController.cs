...
namespace R2HBook.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        [HttpGet("{Age}", Name = "GetStudent")]
        public IActionResult GetById(int Age)
        {
            var item = _context.Students.FirstOrDefault(student => student.Age == age);
            if (item == null)
            {
                return NotFound();
            }
